...
cap = cv.VideoCapture(r"/home/david/code/video2.mkv")
...
while True:
    ...
    try:
        ...
        print(str(e))
 #if program stops, send specific values of degree to tell arduino to turn off motors
    if cv.waitKey(1) == ord('q'):
            arduino.write(b"<")
            arduino.write(bytes(str(999), 'utf-8'))
            arduino.write(b"*")
            arduino.write(bytes(str(999), 'utf-8'))
            arduino.write(b">")
            break
